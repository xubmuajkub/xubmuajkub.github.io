...
const DESC = {
  ...
  bylateral: {
    en:'BOS — a core banking platform. Spring Boot and NestJS microservices for customers, accounts, transactions, payment rails, card processing and compliance, with Temporal orchestrating onboarding, transfers and settlement, RabbitMQ domain events, a Formance ledger and schema-isolated PostgreSQL. React client and admin apps on top.',
    vi:'BOS — nền tảng ngân hàng lõi. Các microservice Spring Boot và NestJS cho khách hàng, tài khoản, giao dịch, kênh thanh toán, xử lý thẻ và tuân thủ, với Temporal điều phối onboarding, chuyển tiền và quyết toán, sự kiện miền qua RabbitMQ, sổ cái Formance và PostgreSQL tách schema. Ứng dụng khách và quản trị bằng React ở phía trên.',
    th:'BOS — แพลตฟอร์มคอร์แบงกิ้ง ไมโครเซอร์วิส Spring Boot และ NestJS สำหรับลูกค้า บัญชี ธุรกรรม ช่องทางชำระเงิน การประมวลผลบัตร และการกำกับดูแล โดยมี Temporal ควบคุมกระบวนการเปิดบัญชี โอนเงิน และเคลียร์ยอด, โดเมนอีเวนต์ผ่าน RabbitMQ, บัญชีแยกประเภทด้วย Formance และ PostgreSQL แยกสกีมา พร้อมแอปลูกค้าและผู้ดูแลด้วย React',
    lo:'BOS — ແພລດຟອມຄໍແບັງກິ້ງ. ໄມໂຄຣເຊີວິສ Spring Boot ແລະ NestJS ສຳລັບລູກຄ້າ, ບັນຊີ, ທຸລະກຳ, ຊ່ອງທາງຊຳລະເງິນ, ການປະມວນຜົນບັດ ແລະ ການກຳກັບດູແລ, ໂດຍມີ Temporal ຄວບຄຸມການເປີດບັນຊີ, ໂອນເງິນ ແລະ ເຄລຍຍອດ, ໂດເມນອີເວັນຜ່ານ RabbitMQ, ບັນຊີແຍກປະເພດດ້ວຍ Formance ແລະ PostgreSQL ແຍກສະກີມາ. ພ້ອມແອັບລູກຄ້າ ແລະ ຜູ້ດູແລດ້ວຍ React.' },
  'harkmed-web': {
